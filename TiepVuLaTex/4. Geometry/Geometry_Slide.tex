...
%11/2019 with \printbibliography at the end
%to solve problem of bibtex -> biber
\usepackage{biblatex} 
...
% =========================== New Slide =================================
\begin{frame}
\frametitle{Drawing in \textrm{\LaTeX}}
Packages for drawing in \mylatex: 
\begin{itemize}
  \item \href{http://www.texample.net/tikz/examples/}{\tcb TikZ}
  \item \href{http://tug.org/PSTricks/main.cgi}{\tcb PSTricks}
  \item ...
\end{itemize}

\medskip 

Sources: \href{http://tex.stackexchange.com/questions/205/what-graphics-packages-are-there-for-creating-graphics-in-latex-documents}{\tcb What graphics packages are there for creating graphics in LaTeX documents?}

GUI tools for vector graphics: 
\begin{itemize}
  \item \href{https://www.geogebra.org/cms/}{\tcb GeoGebra} ( \href{https://www.geogebra.org/geometry}{online GeoGebra})
  \item \href{https://inkscape.org/en/}{\tcb Inkscape}
  \item \dots
\end{itemize}
\medskip 

In the following videos, I'll focus on drawing {\bf Euclidean} geometric shapes using \href{http://www.altermundus.fr/downloads/documents/Sangaku.pdf}{\tcb tkz-euclide} package.
\end{frame}
